...
# 52 "C:\Program Files (x86)\Microchip\xc8\v2.05\pic\include\pic18lf46k40.h"
...
# 722 "mcc_generated_files/pin_manager.h"
...
if (ledIndex == R) {
LATDbits.LATD5 = mode2;
} else if (ledIndex == G) {
LATDbits.LATD6 = mode2;
} else if (ledIndex == B) {
LATDbits.LATD7 = mode2;
} else if (ledIndex == RGB_R) {
LATEbits.LATE2 = mode2;
} else if (ledIndex == RGB_G) {
LATEbits.LATE1 = mode2;
} else if (ledIndex == RGB_B) {
LATEbits.LATE0 = mode2;
}
}

int GetLed(int ledIndex) {
if (ledIndex == R) {
return LATDbits.LATD5;
} else if (ledIndex == G) {
return LATDbits.LATD6;
} else if (ledIndex == B) {
return LATDbits.LATD7;
} else if (ledIndex == RGB_R) {
return LATEbits.LATE2;
} else if (ledIndex == RGB_G) {
return LATEbits.LATE1;
} else if (ledIndex == RGB_B) {
