...
# 52 "C:\Program Files (x86)\Microchip\xc8\v2.05\pic\include\pic18f46k40.h"
...
# 7604
extern volatile unsigned char RD0PPS __at(0xEFF);

asm("RD0PPS equ 0EFFh");
...
extern volatile RD0PPSbits_t RD0PPSbits __at(0xEFF);

# 7648
extern volatile unsigned char RD1PPS __at(0xF00);

asm("RD1PPS equ 0F00h");
...
extern volatile RD1PPSbits_t RD1PPSbits __at(0xF00);

# 7692
extern volatile unsigned char RD2PPS __at(0xF01);

asm("RD2PPS equ 0F01h");
...
extern volatile RD2PPSbits_t RD2PPSbits __at(0xF01);

# 7736
extern volatile unsigned char RD3PPS __at(0xF02);

asm("RD3PPS equ 0F02h");
...
extern volatile RD3PPSbits_t RD3PPSbits __at(0xF02);

# 7780
extern volatile unsigned char RD4PPS __at(0xF03);

asm("RD4PPS equ 0F03h");
...
extern volatile RD4PPSbits_t RD4PPSbits __at(0xF03);

# 7824
extern volatile unsigned char RD5PPS __at(0xF04);

asm("RD5PPS equ 0F04h");
...
extern volatile RD5PPSbits_t RD5PPSbits __at(0xF04);

# 7868
extern volatile unsigned char RD6PPS __at(0xF05);

asm("RD6PPS equ 0F05h");
...
extern volatile RD6PPSbits_t RD6PPSbits __at(0xF05);

# 7912
extern volatile unsigned char RD7PPS __at(0xF06);

asm("RD7PPS equ 0F06h");
...
extern volatile RD7PPSbits_t RD7PPSbits __at(0xF06);

# 7956
extern volatile unsigned char RE0PPS __at(0xF07);

asm("RE0PPS equ 0F07h");
...
extern volatile RE0PPSbits_t RE0PPSbits __at(0xF07);

# 8000
extern volatile unsigned char RE1PPS __at(0xF08);

asm("RE1PPS equ 0F08h");
...
extern volatile RE1PPSbits_t RE1PPSbits __at(0xF08);

# 8044
extern volatile unsigned char RE2PPS __at(0xF09);

asm("RE2PPS equ 0F09h");
...
extern volatile RE2PPSbits_t RE2PPSbits __at(0xF09);
...
# 9576
extern volatile unsigned char INLVLD __at(0xF22);

asm("INLVLD equ 0F22h");
...
extern volatile INLVLDbits_t INLVLDbits __at(0xF22);

# 9638
extern volatile unsigned char SLRCOND __at(0xF23);

asm("SLRCOND equ 0F23h");
...
extern volatile SLRCONDbits_t SLRCONDbits __at(0xF23);

# 9700
extern volatile unsigned char ODCOND __at(0xF24);

asm("ODCOND equ 0F24h");
...
extern volatile ODCONDbits_t ODCONDbits __at(0xF24);

# 9762
extern volatile unsigned char WPUD __at(0xF25);
...
extern volatile WPUDbits_t WPUDbits __at(0xF25);

# 9824
extern volatile unsigned char ANSELD __at(0xF26);

asm("ANSELD equ 0F26h");
...
extern volatile ANSELDbits_t ANSELDbits __at(0xF26);
...
# 9987
extern volatile unsigned char SLRCONE __at(0xF2B);

asm("SLRCONE equ 0F2Bh");
...
extern volatile SLRCONEbits_t SLRCONEbits __at(0xF2B);

# 10019
extern volatile unsigned char ODCONE __at(0xF2C);

asm("ODCONE equ 0F2Ch");
...
extern volatile ODCONEbits_t ODCONEbits __at(0xF2C);
...
# 10089
extern volatile unsigned char ANSELE __at(0xF2E);

asm("ANSELE equ 0F2Eh");
...
extern volatile ANSELEbits_t ANSELEbits __at(0xF2E);
...
# 16723
extern volatile unsigned char LATD __at(0xF86);
...
extern volatile LATDbits_t LATDbits __at(0xF86);

# 16835
extern volatile unsigned char LATE __at(0xF87);
...
extern volatile LATEbits_t LATEbits __at(0xF87);
...
# 17298
extern volatile unsigned char TRISD __at(0xF8B);

asm("TRISD equ 0F8Bh");


extern volatile unsigned char DDRD __at(0xF8B);
...
extern volatile TRISDbits_t TRISDbits __at(0xF8B);
...
extern volatile DDRDbits_t DDRDbits __at(0xF8B);

# 17420
extern volatile unsigned char TRISE __at(0xF8C);

asm("TRISE equ 0F8Ch");


extern volatile unsigned char DDRE __at(0xF8C);
...
extern volatile TRISEbits_t TRISEbits __at(0xF8C);
...
extern volatile DDREbits_t DDREbits __at(0xF8C);
...
# 17723
extern volatile unsigned char PORTD __at(0xF90);
...
extern volatile PORTDbits_t PORTDbits __at(0xF90);
...
extern volatile __bit ANSELD0 __at(0x7930);


extern volatile __bit ANSELD1 __at(0x7931);


extern volatile __bit ANSELD2 __at(0x7932);


extern volatile __bit ANSELD3 __at(0x7933);


extern volatile __bit ANSELD4 __at(0x7934);


extern volatile __bit ANSELD5 __at(0x7935);


extern volatile __bit ANSELD6 __at(0x7936);


extern volatile __bit ANSELD7 __at(0x7937);


extern volatile __bit ANSELE0 __at(0x7970);


extern volatile __bit ANSELE1 __at(0x7971);


extern volatile __bit ANSELE2 __at(0x7972);
...
extern volatile __bit INLVLD0 __at(0x7910);


extern volatile __bit INLVLD1 __at(0x7911);


extern volatile __bit INLVLD2 __at(0x7912);


extern volatile __bit INLVLD3 __at(0x7913);


extern volatile __bit INLVLD4 __at(0x7914);


extern volatile __bit INLVLD5 __at(0x7915);


extern volatile __bit INLVLD6 __at(0x7916);


extern volatile __bit INLVLD7 __at(0x7917);


extern volatile __bit INLVLE0 __at(0x7950);


extern volatile __bit INLVLE1 __at(0x7951);


extern volatile __bit INLVLE2 __at(0x7952);
...
extern volatile __bit LATD0 __at(0x7C30);


extern volatile __bit LATD1 __at(0x7C31);


extern volatile __bit LATD2 __at(0x7C32);


extern volatile __bit LATD3 __at(0x7C33);


extern volatile __bit LATD4 __at(0x7C34);


extern volatile __bit LATD5 __at(0x7C35);


extern volatile __bit LATD6 __at(0x7C36);


extern volatile __bit LATD7 __at(0x7C37);


extern volatile __bit LATE0 __at(0x7C38);


extern volatile __bit LATE1 __at(0x7C39);


extern volatile __bit LATE2 __at(0x7C3A);
...
extern volatile __bit LD0 __at(0x7C30);


extern volatile __bit LD1 __at(0x7C31);


extern volatile __bit LD2 __at(0x7C32);


extern volatile __bit LD3 __at(0x7C33);


extern volatile __bit LD4 __at(0x7C34);


extern volatile __bit LD5 __at(0x7C35);


extern volatile __bit LD6 __at(0x7C36);


extern volatile __bit LD7 __at(0x7C37);


extern volatile __bit LE0 __at(0x7C38);


extern volatile __bit LE1 __at(0x7C39);


extern volatile __bit LE2 __at(0x7C3A);


extern volatile __bit LE3 __at(0x7C3B);


extern volatile __bit LE4 __at(0x7C3C);


extern volatile __bit LE5 __at(0x7C3D);


extern volatile __bit LE6 __at(0x7C3E);


extern volatile __bit LE7 __at(0x7C3F);
...
extern volatile __bit ODCD0 __at(0x7920);


extern volatile __bit ODCD1 __at(0x7921);


extern volatile __bit ODCD2 __at(0x7922);


extern volatile __bit ODCD3 __at(0x7923);


extern volatile __bit ODCD4 __at(0x7924);


extern volatile __bit ODCD5 __at(0x7925);


extern volatile __bit ODCD6 __at(0x7926);


extern volatile __bit ODCD7 __at(0x7927);


extern volatile __bit ODCE0 __at(0x7960);


extern volatile __bit ODCE1 __at(0x7961);


extern volatile __bit ODCE2 __at(0x7962);
...
extern volatile __bit RD0 __at(0x7C80);


extern volatile __bit RD0PPS0 __at(0x77F8);


extern volatile __bit RD0PPS1 __at(0x77F9);


extern volatile __bit RD0PPS2 __at(0x77FA);


extern volatile __bit RD0PPS3 __at(0x77FB);


extern volatile __bit RD0PPS4 __at(0x77FC);


extern volatile __bit RD1 __at(0x7C81);
...
extern volatile __bit RD1PPS0 __at(0x7800);


extern volatile __bit RD1PPS1 __at(0x7801);


extern volatile __bit RD1PPS2 __at(0x7802);


extern volatile __bit RD1PPS3 __at(0x7803);


extern volatile __bit RD1PPS4 __at(0x7804);


extern volatile __bit RD2 __at(0x7C82);


extern volatile __bit RD2PPS0 __at(0x7808);


extern volatile __bit RD2PPS1 __at(0x7809);


extern volatile __bit RD2PPS2 __at(0x780A);


extern volatile __bit RD2PPS3 __at(0x780B);


extern volatile __bit RD2PPS4 __at(0x780C);


extern volatile __bit RD3 __at(0x7C83);


extern volatile __bit RD3PPS0 __at(0x7810);


extern volatile __bit RD3PPS1 __at(0x7811);


extern volatile __bit RD3PPS2 __at(0x7812);


extern volatile __bit RD3PPS3 __at(0x7813);


extern volatile __bit RD3PPS4 __at(0x7814);


extern volatile __bit RD4 __at(0x7C84);


extern volatile __bit RD4PPS0 __at(0x7818);


extern volatile __bit RD4PPS1 __at(0x7819);


extern volatile __bit RD4PPS2 __at(0x781A);


extern volatile __bit RD4PPS3 __at(0x781B);


extern volatile __bit RD4PPS4 __at(0x781C);


extern volatile __bit RD5 __at(0x7C85);


extern volatile __bit RD5PPS0 __at(0x7820);


extern volatile __bit RD5PPS1 __at(0x7821);


extern volatile __bit RD5PPS2 __at(0x7822);


extern volatile __bit RD5PPS3 __at(0x7823);


extern volatile __bit RD5PPS4 __at(0x7824);


extern volatile __bit RD6 __at(0x7C86);


extern volatile __bit RD6PPS0 __at(0x7828);


extern volatile __bit RD6PPS1 __at(0x7829);


extern volatile __bit RD6PPS2 __at(0x782A);


extern volatile __bit RD6PPS3 __at(0x782B);


extern volatile __bit RD6PPS4 __at(0x782C);


extern volatile __bit RD7 __at(0x7C87);


extern volatile __bit RD7PPS0 __at(0x7830);


extern volatile __bit RD7PPS1 __at(0x7831);


extern volatile __bit RD7PPS2 __at(0x7832);


extern volatile __bit RD7PPS3 __at(0x7833);


extern volatile __bit RD7PPS4 __at(0x7834);
...
extern volatile __bit RE0PPS0 __at(0x7838);


extern volatile __bit RE0PPS1 __at(0x7839);


extern volatile __bit RE0PPS2 __at(0x783A);


extern volatile __bit RE0PPS3 __at(0x783B);


extern volatile __bit RE0PPS4 __at(0x783C);


extern volatile __bit RE1 __at(0x7C89);


extern volatile __bit RE1PPS0 __at(0x7840);


extern volatile __bit RE1PPS1 __at(0x7841);


extern volatile __bit RE1PPS2 __at(0x7842);


extern volatile __bit RE1PPS3 __at(0x7843);


extern volatile __bit RE1PPS4 __at(0x7844);


extern volatile __bit RE2 __at(0x7C8A);


extern volatile __bit RE2PPS0 __at(0x7848);


extern volatile __bit RE2PPS1 __at(0x7849);


extern volatile __bit RE2PPS2 __at(0x784A);


extern volatile __bit RE2PPS3 __at(0x784B);


extern volatile __bit RE2PPS4 __at(0x784C);
...
extern volatile __bit SLRD0 __at(0x7918);


extern volatile __bit SLRD1 __at(0x7919);


extern volatile __bit SLRD2 __at(0x791A);


extern volatile __bit SLRD3 __at(0x791B);


extern volatile __bit SLRD4 __at(0x791C);


extern volatile __bit SLRD5 __at(0x791D);


extern volatile __bit SLRD6 __at(0x791E);


extern volatile __bit SLRD7 __at(0x791F);


extern volatile __bit SLRE0 __at(0x7958);


extern volatile __bit SLRE1 __at(0x7959);


extern volatile __bit SLRE2 __at(0x795A);
...
extern volatile __bit SS2 __at(0x7C87);
...
extern volatile __bit TRISD0 __at(0x7C58);


extern volatile __bit TRISD1 __at(0x7C59);


extern volatile __bit TRISD2 __at(0x7C5A);


extern volatile __bit TRISD3 __at(0x7C5B);


extern volatile __bit TRISD4 __at(0x7C5C);


extern volatile __bit TRISD5 __at(0x7C5D);


extern volatile __bit TRISD6 __at(0x7C5E);


extern volatile __bit TRISD7 __at(0x7C5F);


extern volatile __bit TRISE0 __at(0x7C60);


extern volatile __bit TRISE1 __at(0x7C61);


extern volatile __bit TRISE2 __at(0x7C62);
...
extern volatile __bit WPUD0 __at(0x7928);


extern volatile __bit WPUD1 __at(0x7929);


extern volatile __bit WPUD2 __at(0x792A);


extern volatile __bit WPUD3 __at(0x792B);


extern volatile __bit WPUD4 __at(0x792C);


extern volatile __bit WPUD5 __at(0x792D);


extern volatile __bit WPUD6 __at(0x792E);


extern volatile __bit WPUD7 __at(0x792F);


extern volatile __bit WPUE0 __at(0x7968);


extern volatile __bit WPUE1 __at(0x7969);


extern volatile __bit WPUE2 __at(0x796A);
...
# 32 "mcc_generated_files/drivers/i2c_master.c"
typedef enum {
I2C_IDLE = 0,
I2C_SEND_ADR_READ,
I2C_SEND_ADR_WRITE,
...
i2c_status.callbackPayload[i2c_dataComplete] = (0);
i2c_status.callbackTable[i2c_writeCollision]=returnStop;
i2c_status.callbackPayload[i2c_writeCollision] = (0);
i2c_status.callbackTable[i2c_addressNACK]=returnStop;
i2c_status.callbackPayload[i2c_addressNACK] = (0);
i2c_status.callbackTable[i2c_dataNACK]=returnStop;
i2c_status.callbackPayload[i2c_dataNACK] = (0);
