...
# 37 "ext_rf_receiver.h"
unsigned char EXT_TARGET_RF_RX = 0;
...
_delay((unsigned long)((1)*(24000000/4000.0)));
}
}

void Delay_Xus(long delay) {
for(long i = 0; i < delay; i++) {
_delay((unsigned long)((1)*(24000000/4000000.0)));
}
}

void INT0_Custom_ISR(void) {

unsigned char index = I2C_SendCommand(EXT_TARGET_RF_RX,0x50);
